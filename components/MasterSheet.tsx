  ...
  return (
    <div className="bg-white p-4 print:p-0 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12 page-break-inside-avoid">
        ...
        {/* Grading System Key */}
        <div>
           <h4 className="font-bold border-b-2 border-black mb-2 uppercase">Grading System Key</h4>
           <table className="w-full text-sm border-collapse border border-gray-400">
             <thead className="bg-gray-100">
                <tr>
             ...
             <tbody>
                {grades.map((g, idx) => (
                  <tr key={g}>
                    ...
                    <td className="border border-gray-400 p-1 text-xs text-gray-500 italic">{cutoffs[idx]}</td>
                  </tr>
                ))}
             </tbody>
           </table>
